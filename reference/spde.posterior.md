...
log(variance) parameter of a model's SPDE component. Can also plot
Matern correlation or covariance function. `inla.spde.result`.
...
- what:
  ...
  One of "range", "log.range", "variance", "log.variance",
