...
```
If you have an R installation with PROJ6/GDAL3 and INLA >= 18.06.18, you will need to update the CRS information in the gorillas data after reading it in:
```{r update_CRS,eval = FALSE}
