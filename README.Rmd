...
[![Codecov test coverage](https://codecov.io/gh/inlabru-org/inlabru/graph/badge.svg)](https://app.codecov.io/gh/inlabru-org/inlabru)
<!-- badges: end -->

The goal of [inlabru](http://inlabru.org) is to facilitate spatial modelling
using integrated nested Laplace approximation via the [R-INLA package](https://www.r-inla.org).
...
for the latest CRAN/stable release, and at
[https://inlabru-org.github.io/inlabru/dev/articles/](https://inlabru-org.github.io/inlabru/dev/articles/)
...
This is a basic example which shows how fit a simple spatial Log Gaussian Cox Process (LGCP)
...
```
```{r plot,fig.cap="Nest intensity per km squared"}
# Plot the result
ggplot() +
...
You can install the current [CRAN version](https://cran.r-project.org/package=inlabru) version of inlabru, using the basic `install.packages()` function, or [pak](https://pak.r-lib.org/),
after adding the INLA repository added to the list of repositories:
