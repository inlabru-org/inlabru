...
* `block_rescale = "count"` corresponds to `rescale = TRUE` and providing no
`weights`, as that is interpreted as all weights being `1`, so rescaling by
the sum of the weights is equivalent to dividing by the number of elements in each block.
