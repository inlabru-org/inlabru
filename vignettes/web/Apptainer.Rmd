...
$ apptainer pull name_your_containter.sif docker://rocker/geospatial:latest
# once the sif is downloaded, get into an interactive shell 
$ apptainer shell name_your_containter.sif
...
```{r exec, eval=FALSE}
# To execute the R file with apptainer
$ apptainer exec ./name_your_containter.sif Rscript --no-restore --no-save --verbose file_to_run.R
```
