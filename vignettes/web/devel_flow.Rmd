...
DiagrammeR::grViz("digraph {
  ...
  node [shape = oval]
  input_comb [label = 'combined inputs']
  mapper [label = 'mapper']
  multi_mapper [label = 'mapper_multi']
  scale_mapper [label = 'mapper_scale']
  ...
  ibm_is_lin [label = 'If ibm_is_linear']
  ibm_lin [label = 'ibm_linear']
  ibm_jac [label = 'ibm_jacobian']
  ibm_off [label = 'ibm_offset']
  ibm_eval [label = 'ibm_eval']
  
  # edge definitions with the node IDs
  {input weights} -> input_comb
  input_comb -> {ibm_eval ibm_lin}
  scale_mapper -> {ibm_eval ibm_is_lin}
  ibm_is_lin -> ibm_lin
  ibm_lin -> {ibm_jac ibm_off lin}
  lin -> ibm_eval
  ibm_jac -> A
  ibm_off -> off
  ibm_jac -> ibm_A [dir = 'none']
  state -> {ibm_eval ibm_lin}
