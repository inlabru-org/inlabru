...
comps <- ~ vegetation(gcov$vegetation, model = "factor_full",
...
df <- data.frame(
  ...
  expectation = c(lambda_poi$mean * counts_df$area,
                  lambda_zip$mean * counts_df$area,
                  lambda_zap$mean * counts_df$area),
  median = c(lambda_poi$median * counts_df$area,
                  lambda_zip$median * counts_df$area,
                  lambda_zap$median * counts_df$area),
  pit = c(fit_poi$cpo$pit * c(NA_real_, 1)[1 + (counts_df$count > 0)],
