...
e.pred <- predict(efit,
                  pred.df,
                  ~ list(int = exp(mySmooth + elev + Intercept),
...
ggplot() +
  gg(prcov1D$total, aes(colour = "Intensity", fill = "Intensity"), alpha = 0.2, lwd = 1.25) +
  gg(prcov1D$spde, aes(colour = "spde", fill = "spde"), alpha = 0.2, lwd = 1.25) +
  gg(prcov1D$fx, aes(colour = "z-effect", fill = "z-effect"), alpha = 0.2, lwd = 1.25) +
